...
class Products with ChangeNotifier {
  ...
  Future<void> getProductsFromFirebase([bool filterByUser = false]) async {
    ...
    final url = Uri.parse(
        'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products.json?auth=$_authToken&$filterString');
    ...
    try {
      ...
      if (jsonDecode(response.body) != null) {
        final favoriteUrl = Uri.parse(
            'https://fir-app-c6d6d-default-rtdb.firebaseio.com/userFavorites/$_userId.json?auth=$_authToken');
  ...
  Future<void> addProduct(Product product) async {
    ...
    final url = Uri.parse(
        'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products.json?auth=$_authToken');
  ...
  Future<void> updateProduct(Product updatedProduct) async {
    ...
    if (productIndex >= 0) {
      final url = Uri.parse(
          'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products/${updatedProduct.id}.json?auth=$_authToken');
      try {
        await http.patch(
          url,
          body: jsonEncode(
  ...
  Future<void> deleteProduct(String id) async {
    final url = Uri.parse(
        'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products/$id.json?auth=$_authToken');
