...
class Products with ChangeNotifier {
  ...
  Future<void> getProductsFromFirebase() async {
    final url = Uri.parse(
        'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products.json');
  ...
  Future<void> updateProduct(Product updatedProduct) async {
    ...
    if (productIndex >= 0) {
      final url = Uri.parse(
          'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products/${updatedProduct.id}.json');
      try {
        await http.patch(
          url,
          body: jsonEncode(
  ...
  Future<void> deleteProduct(String id) async {
    final url = Uri.parse(
        'https://fir-app-c6d6d-default-rtdb.firebaseio.com/products/$id.json');
